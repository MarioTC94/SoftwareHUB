...
namespace src\Model\Domain {
	...
	class Incidente
	{
		...
		public static function createIncidente($PK_IDIncidente, $NombreIncidente, $DescripcionIncidente, $EstadoIncidente, $TipoIncidente, $Cliente, $Proveedor, $IDSoftware, $FechaIncidente, $Activo)
		{
			$instance = new self();
			...
			$instance->FechaIncidente = $FechaIncidente;
		...
		public function toJSON()
		{
			...
			$arrayIncidente[FechaIncidente] = $this->FK_[FechaIncidente];
