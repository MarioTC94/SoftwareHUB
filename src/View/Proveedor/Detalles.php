         ...
         <div class="row">
            <div class="col-lg-12">
               <h1 class="page-header">
                  <?= $model['Incidente']['NombreIncidente'] ?>
               </h1>
            </div>
         </div>
         <div class="row">
            <div class="col-md-8">
               <div class="row">
                  <div class="col-lg-4 col-md-6">
                     <div class="panel panel-primary">
                        ...
                        <div class="panel-footer">
                           ...
                           <div class="text-primary">Software:
                              <?= $model['Incidente']['NombreSoftware'] ?>
                           </div>
                        </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="panel panel-green">
                        ...
                        <div class="panel-footer">
                           <div class="clearfix"></div>
                           <div class="text-green">Tipo:
                              <?= $model['Incidente']['DescripcionTipoIncidente'] ?>
                           </div>
                        </div>
                  ...
                  <div class="col-lg-4 col-md-12">
                     <div class="panel panel-yellow">
                        ...
                        <div class="panel-footer">
                           <div class="clearfix"></div>
                           <div class="text-yellow">Estado:
                              <?= $model['Incidente']['DescripcionEstadoIncidente'] ?>
                           </div>
                        </div>
                  ...
                  <div class="col-lg-12">
                     <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                           <p>
                              <?= $model['Incidente']['DescripcionIncidente'] ?>
                           </p>
                        </div>
                        <div>
                        </div>
               ...
               <div class="col-lg-12">
                  <div class="panel panel-green">
                     <div class="panel-heading">
                        Cambio del estado del incidente
                     </div>
                     <div class="panel-body">
                        <form class="form-horizontal" id="FormUpdateState"> 
                            <div class="form-group">
                                <label class="control-label col-sm-6" for="CBIDIncidnte">Seleccione el estado de este incidente: </label>
                                <div class="col-sm-6">
                        ...
                        <li class="<?= $value['Posicion'] ?> clearfix">
                           ...
                           <div class="chat-body clearfix">
                              <div class="header">
                                 ...
                                 <strong class="pull-<?= $value['Posicion'] ?> primary-font">
                                    <?= $value['Nombre'] ?>
                                 </strong>
                              </div>
                              <hr>
