...
INSERT INTO TipoSoftware(DescripcionTipoSoftware) VALUES('Salud'),('Facturación'),('Educación'),('Política'),('Entretenimiento'),('Móviles'),('Belleza'),('Fotografia'),('Compras'),('Estilo de vida'),('Arte y Diseño'),('Arquitectura'),('Comunicación'),('Desarrollo'),('Sistemas Operativos'),('Otros');
...
(
    ...
    CONSTRAINT FK_Incidente_Software FOREIGN KEY(IDSoftware) REFERENCES Software(PK_IDSoftware) ON DELETE CASCADE ON UPDATE CASCADE,
	Activo BIT NOT NULL DEFAULT 1
) ENGINE=INNODB;
